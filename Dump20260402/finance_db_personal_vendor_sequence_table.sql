...
DROP TABLE IF EXISTS `personal_vendor_sequence_table`;
...
LOCK TABLES `personal_vendor_sequence_table` WRITE;
/*!40000 ALTER TABLE `personal_vendor_sequence_table` DISABLE KEYS */;
/*!40000 ALTER TABLE `personal_vendor_sequence_table` ENABLE KEYS */;
UNLOCK TABLES;
