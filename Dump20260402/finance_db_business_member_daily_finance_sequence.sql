...
DROP TABLE IF EXISTS `business_member_daily_finance_sequence`;
...
LOCK TABLES `business_member_daily_finance_sequence` WRITE;
/*!40000 ALTER TABLE `business_member_daily_finance_sequence` DISABLE KEYS */;
/*!40000 ALTER TABLE `business_member_daily_finance_sequence` ENABLE KEYS */;
UNLOCK TABLES;
