...
public class BusinessShareController {
	...
	public ResponseEntity<BusinessShareResponsePojo> getBusinessShareStatement(@PathVariable String fromDate,
		...
		return ResponseEntity.ok().body(businessShareService.getBusinessShareStatement(fromLocalDate, toLocalDate));
	}
