...
public class BalanceSheetController {
	...
	public List<BalanceSheetProjection> getBalanceSheetByTrasncDate(@PathVariable String toDate) {

		DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd");

		LocalDate toLocalDate = LocalDate.parse(toDate, formatter);

		return balanceSheetService.getBalanceSheetByTrasncDate(toLocalDate);
	}
