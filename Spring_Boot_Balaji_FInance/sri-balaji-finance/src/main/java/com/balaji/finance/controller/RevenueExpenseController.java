...
public class RevenueExpenseController {
	...
	public List<RevenueExpenseProjection> getRevenueExpense(@PathVariable String fromDate,
		...
		return revenueExpenseService.getRevenueExpenseStatementByTrasncDate(fromLocalDate, toLocalDate);
	}

	@GetMapping("/revenueExpenseStatement")
	public List<RevenueExpenseProjection> getRevenueExpense() {
		return revenueExpenseService.getRevenueExpenseStatement();
	}
